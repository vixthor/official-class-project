...
<main>
    <div class="contact_Us flex items-center justify-center mb-2">
        <h2 class="text-8xl text-center font-serif">Contact <br class=""> Us</h2>
    </div>

    <div class="container grid grid-rows lg:grid-cols-2 gap-12 p-12 mt-6 mb-6 text-center  mx-auto">
        <div class="left-side rounded-2xl border h-96 border-teal-500 bg-teal-500 text-white">
